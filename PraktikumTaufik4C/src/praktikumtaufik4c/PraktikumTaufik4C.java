 ...
 * @author ASUS
 */
public class PraktikumTaufik4C {
    ...
    public static void main(String[] args) {
        ...
        //penggajian praktik = new penggajian("Menikah", "Gol 1", 0, 0);
        
       /*praktik.setStatus("Menikah");
        System.out.println(praktik.getTunjStatus());
        
        praktik.setjumlahAnak(5);
       ...
       //System.out.println(praktik.gajiTotal());
       ...
       kabupaten.add("Banjar");
       kabupaten.add("Hulu sungai tengah");
       kabupaten.add("Hulu sungai selatan");
